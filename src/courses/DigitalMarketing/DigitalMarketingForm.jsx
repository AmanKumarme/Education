...
const DigitalMarketingForm = () => {
  ...
  return (
    ...
    <form className={DigitalStyles.form} action="/register" onSubmit={handleSubmit}>
     <div>
     ...
     <select className="form-control py-2" required onChange={handleChange} name="courses" id="">
         ...
         <option value="SEO from Digital Marketing">SEO</option>
         <option value="SEM from Digital Marketing">SEM</option>
       </select>
     </div>
     <div>
